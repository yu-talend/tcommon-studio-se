...
public class ModuleNeededTest {
    ...
    public void testEquals() {
        ...
        ModuleNeeded module5 = new ModuleNeeded("tMysqlInput", "test1.jar", "description 1", false, null, "version = 'MYSQL_5'",
    ...
    public void getGetMavenUri() {
        ...
        Assert.assertEquals(module2.getMavenUri(), null);
        ...
        Assert.assertEquals(module3.getMavenUri(), null);
